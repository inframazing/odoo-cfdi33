...
class amount_to_text:
    ...
    def __init__(self):
        ...
        self._n11 = ('un', 'dos', 'tres', 'cuatro', 'cinco', 'seis', 'siete', 'ocho',
                     'nueve')
        self._n2 = ('dieci', 'veinti', 'treinta', 'cuarenta', 'cincuenta', 'sesenta',
                    'setenta', 'ochenta', 'noventa')
        self._n3 = ('ciento', 'dosc', 'tresc', 'cuatroc', 'quin', 'seisc', 'setec',
                    'ochoc', 'novec')
    ...
    def _amount_to_text(self, n, lFemenino=0):
        ...
        """
        prim, resto = divmod(n, 1000000000000L)
        if prim != 0:
            if prim == 1:
                cRes = 'un billon'
            else:
                cRes = self._amount_to_text(prim, 0) + ' billones'
            if resto != 0:
            ...
            if prim != 0:
                if prim == 1:
                    ...
                    cRes = self._amount_to_text(prim, 0) + ' millones'
                if resto != 0:
                    cRes += ' ' + self._amount_to_text(resto, lFemenino)
            else:
...
def get_amount_to_text(amount, currency='MXN'):
    """
